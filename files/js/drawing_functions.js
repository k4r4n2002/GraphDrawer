...
function addNode(graphId, options) {
	...
	var connectBtn = makeSVG('image', {
		...
		y : options.y - radius - 8,
		height : "14px",
		width : "14px",
		'class' : 'buttons connect',
		href : "files/img/connect-from.png",
		xlink : href = "files/img/connect-from.png",
		visibility : "hidden",
	});
	...
	var editBtn = makeSVG('image', {
		...
		width : "14px",
		'class' : 'buttons edit',
		href : "files/img/edit.png",
		xlink : href = "files/img/edit.png",
		visibility : "hidden",
	});
	// add connect image button to the group
	...
	var deleteBtn = makeSVG('image', {
		...
		href : "files/img/small_delete.png",
		xlink : href = "files/img/small_delete.png",
		visibility : "hidden",
	});
	// add connect image button to the group
	...
	for (var i = 0; i < tooltips.length; i++) {
		if (isConnectTo == true) {
			tooltips[i].setAttributeNS(null, "href",
					"files/img/connect-to.png");
			tooltips[i].setAttributeNS(null, "xlink",
					'href = "files/img/connect-to.png"');
		} else {
			tooltips[i].setAttributeNS(null, "href",
					"files/img/connect-from.png");
			tooltips[i].setAttributeNS(null, "xlink",
					'href = "files/img/connect-from.png"');
		}
	}
...
function setChartInfoSubPanel(graphId) {
	...
	// chart title and id
	html += '<div class="subPanelTitle row">General Info</div>'
